...
<div class="page-sidebar" id="main-menu">
    ...
    <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
        ...
        <ul>
            ...
            <li <?php echo ((isset($page) && $page == 'refund') ? 'class="active"' : ""); ?>> <a href="<?php echo base_url(); ?>refundmst/"> <i class="fa fa-undo"></i> <span class="title">Refund Request </span></a></li>
            <li <?php echo ((isset($page) && $page == 'money') ? 'class="active"' : ""); ?>> <a href="<?php echo base_url(); ?>money_request/"> <i class="fa fa-money"></i> <span class="title">Money Request </span></a></li>
            
            <?php /*<li <?php echo ((isset($page) && ($page == 'flex_question' || $page == 'flex_option')) ? 'class="active open"' : ""); ?>> <a href="javascript:;"> <i class="fa fa-question-circle"></i> <span class="title">Manage Question</span> <span class="arrow "></span> </a>
                <ul class="sub-menu">
