...
<div class="page-content">
    ...
    <div class="content">
        ...
        <div class="page-title"> <i class="icon-custom-left"></i>
            <h3><span class="semi-bold"><?php echo (isset($page_title) ? ucwords($page_title) : "Manage Money Request"); ?></span></h3>
        </div>
        <div id="container">
            <div class="row">
                <div class="row-fluid">
                    <div class="span12">
                        <div class="grid simple horizontal orenge">
                            <div class="grid-title">
                                <h4><span class="semi-bold"><?php echo (isset($page_title) ? ucwords($page_title) : "Manage MOney Request"); ?></span></h4>
                                <?php /*
                            ...
                            <div class="grid-body ">
                                ...
                                <table class="table table-bordered table-advance table-hover" id="money" data-control="money_request" data-method="manage">
                                    <thead>
                                        <tr>
        ...
        <div class="modal-dialog modal-md" >
            <div class="modal-content" id="timetable_model_main">
                ...
                <div class="modal-header">
                    ...
                    <h4><span class="semi-bold" id="myModalLabel2">Money Request Details</span></h4>
                </div>
