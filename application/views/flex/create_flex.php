            ...
            <div class="flexform_box" style="z-index:99999 !important;">
              <?php echo form_open_multipart(base_url('index.php/home/submit_form'), $form_attr); ?>
                <div class="form-group">
                  <div class="pro_banner" data-toggle="modal" data-target="#crop_img">
                      <input type="hidden" id="defulat_img" name="defulat_img" value="<?php echo base_url(); ?>assets/images/banneradd.jpg" />   
                  <img src="<?php echo base_url(); ?>assets/images/banneradd.jpg"  id="change-pic" alt="" style="cursor:pointer;">
                </div>
...
<div class="modal modal-info fade" id="crop_img">
  <div class="modal-dialog full-model">
    <div class="modal-content">
      <div class="modal-header">
          <button type="button" class="btn btn-primary pull-right" data-dismiss="modal"><strong>Close</strong></button>
          <h4><span class="semi-bold" id="myModalLabel2">Add Flex Banner</span></h4>
      </div>
      <div class="modal-body custom-model-body">
          <div class="box-header">
              <label class="btn btn-primary btn-upload" for="inputImage" title="Upload image file">
                ...
                <span class="fa fa-upload"> Select Image</span>
                </span>
              </label>
          </div>  
            ...
            <div class="row">
                <div class="col-md-9">
                  ...
                  <div class="img-container">
                    <img id="image" src="" alt="Pleace Select Image">
                  </div>
                </div>
                <div class="col-md-3">
                  <!-- <h3>Preview:</h3> -->
              ...
              <div class="row">
                  <div class="col-md-9 docs-buttons">
                    ...
                    <div class="btn-group btn-group-crop pull-right" >
                      <button type="button" class="btn btn-primary " style="width: 200px" data-method="getCroppedCanvas" data-option="{ &quot;width&quot;: <?php echo WIDTH;?>, &quot;height&quot;:<?php echo HEIGHT;?> }">
                        <span class="docs-tooltip" data-toggle="tooltip" title="$().cropper(&quot;getCroppedCanvas&quot;, { width: <?php echo WIDTH;?>, height: <?php echo  HEIGHT;?> })">
                          Save
                        </span>
                      </button>  
                    </div>
